  ...
  return (
    <div>
      ...
      <section className="relative">
        ...
        <img src={item.image} alt={item.name} className="h-[34vh] sm:h-[44vh] md:h-[52vh] w-full object-cover" />
          ...
          {Array.isArray(item.gallery) && item.gallery.length > 0 && (
            <div className="mt-6 grid sm:grid-cols-2 gap-4">
              {item.gallery.map((src, i) => (
                <div key={i} className="rounded-xl overflow-hidden shadow-soft h-40 sm:h-48 md:h-56">
