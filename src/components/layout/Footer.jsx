    ...
    <footer className="bg-slate-50 border-t mt-[100px]">
      <div className="container-responsive py-10 grid md:grid-cols-3 gap-8">
        <div>
          ...
          <p className="mt-2 text-slate-600">Khám phá vẻ đẹp xứ hoa vàng cỏ xanh.</p>
          <div className="flex gap-3 mt-4 text-ocean-600">
        ...
        <div>
          <h4 className="text-lg font-semibold text-ocean-700">Liên kết nhanh</h4>
        ...
        <div>
          <h4 className="text-lg font-semibold text-ocean-700">Liên hệ</h4>
          <ul className="mt-2 space-y-2 text-slate-700">
      ...
      <div className="border-t py-4 text-center text-slate-500 text-sm">© {new Date().getFullYear()} Phú Yên Travel. All rights reserved.</div>
    </footer>
  )
}
